      ...
      <div className="h-screen sticky top-0 w-full">
        <div className="overflow-hidden h-full w-full relative">
          <div className='w-full mx-auto h-full relative'>
            ...
            <div style={{ backgroundImage: `url(images/oo.jpg)`}} className='w-full absolute right-0 top-0 z-0 bg-cover h-screen' />
            <div className='xl:max-w-7xl lg:max-w-6xl md:max-w-3xl sm:max-w-xl mx-auto w-full h-screen px-8 relative z-[3]'>
              <div className='relative w-full h-full z-0 flex pt-40 justify-center pb-16'>
                <div className='w-full md:w-9/12 pr-8 relative'>
                  <div className='text-white'>
                    <span className='block md:text-xl lg:text-2xl'>Pioneer in Trekking at Eastern Region</span>
                    <h1 className={`${headingFont.className} heading-text w-full bg-clip-text text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-none font-bold mb-4 will-change-[opacity] uppercase`}>
