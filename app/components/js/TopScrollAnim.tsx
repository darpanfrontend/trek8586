              ...
              <div className='relative w-full h-full z-0 flex items-center justify-center pb-16'>
                <div className='w-9/12 pr-8 relative'>
                  <div className='text-white'>
                    ...
                    <p className='mb-12 text-2xl'>For treks, please contact us at our <span className='block'>
                    <a title='+97798404040309' href="https://wa.me/+97798404040309?text=Hello!%20Suggest%20me%20a%20trek%20please">whatsapp (+97798404040309) number</a> or</span></p>
